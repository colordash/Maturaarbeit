...
#define PG_DECLARE(_type, _name)                                        \
 ...
 /*extern: speichert instanzen von failsafeCongit_t einmal in _System und einmal in _Copy; diese Variabeln sind hier nicht definiert,
    sondern werden irgendwo anderst definiert z.B: 0x20015dd0                failsafeConfig_System.
    103: failsafeConfig(void) gibt einen Zeiger auf die instanz failsafeConfig_System zurück, auf dem nur gelsen werden kann
    104: failsafeConfigMutable(void) gibt einen Zeiger auf die instanz failsafeConfig_System zurück, auf der gelsen und geschrieben werden kann*/
